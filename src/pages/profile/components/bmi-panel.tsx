...
export const BmiPanel = ({ isLoading, bmi }: { isLoading: boolean, bmi: number }) => {
    const data = [
        { value: 25 },
        { value: 16 },
        { value: 14 },
    ...
    return (
        <Panel className="relative w-full grow !p-0 md:w-auto lg:!p-0" highlighted>
            {
            ...
            <div className="flex flex-row lg:flex-col">
                <div className="flex w-fit flex-row p-4 pr-0 lg:px-11 lg:py-12">
                    <span className="text-4xl font-bold lg:text-6xl">{ bmi }</span>
