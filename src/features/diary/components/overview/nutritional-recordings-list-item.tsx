...
export const NutritionalRecordingsListItem = ({ recordingId, description, amount, type, calories, unit }: NutritionalRecording) => {
    const routes = {
        ['FOOD']: DIARY_FOOD_ITEM_ROUTE.replace(':id', recordingId.toString()),
        ['MEAL']: DIARY_MEAL_ITEM_ROUTE.replace(':id', recordingId.toString()),
    }
