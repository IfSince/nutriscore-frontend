...
const mealData: ProgressProps[] = [
    { size: 75, width: 10, name: 'Breakfast', value: 220, total: 350, unit: 'kcal', indicatorStyles: 'stroke-cyan-200' },
    { size: 75, width: 10, name: 'Lunch', value: 250, total: 500, unit: 'kcal', indicatorStyles: 'stroke-cyan-200' },
    { size: 75, width: 10, name: 'Dinner', value: 500, total: 650, unit: 'kcal', indicatorStyles: 'stroke-cyan-200' },
    { size: 75, width: 10, name: 'Snacks', value: 75, total: 200, unit: 'kcal', indicatorStyles: 'stroke-cyan-200' },
]
